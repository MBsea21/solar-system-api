#ignore this file 
# we were not sure if we should create a new folder specifically for path routes, 
#wanted to ask in class but for the meantime used the routes.py folder for paths
#in case that was what was expected. 
